...
$aConfig = array(
	 ...
	 * Main Section.
	 */	
	'title' => 'Youtube-Importer', // module title, this name will be displayed in the modules list
    'version' => '1.1.2', // module version, change this number everytime you publish your mod
	 ...
	 */
	'home_dir' => 'goesi/youtube_auto-import/', // folder where module files are located, it describes path from /modules/ folder.
	'home_uri' => 'youtube_auto-import', // module URI, so the module will be accessable via the following urls: m/bloggie/ or modules/?r=bloggie/
	
	'db_prefix' => 'goesi_yout_', // database prefix for all module tables, it is better to compose it from vendor prefix + module prefix, in out case it is me (vendor prefix) and blgg(Bloggie module prefix)
    'class_prefix' => 'GoesiYou', // class prefix for all module classes, it is better to compose it from vendor prefix + module prefix, in out case it is Me (vendor prefix) and Blgg(Bloggie module prefix)
	 ...
	 */
	'language_category' => 'Youtube-Import',
